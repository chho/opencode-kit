---
name: astro-cms
description: Astro CMS integration guides for 30+ headless CMS platforms - Contentful, Sanity, Strapi, WordPress, Storyblok, Ghost, Directus, Prismic, Drupal, Payload, Keystone, Tina CMS, Decap CMS, DatoCMS, and more. Load this when integrating a specific CMS with your Astro project.
---

# Astro CMS Integration Guides

> This skill contains integration guides for connecting Astro with headless CMS platforms.
